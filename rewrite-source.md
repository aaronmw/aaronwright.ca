...
![Loopio project workspace before the redesign](https://aaronwright.ca/portfolio/loopio-case-study/legacy-project-workspace.png)
...
![Loopio working prototype showing live collaboration](https://aaronwright.ca/portfolio/loopio-case-study/prototype-live-collaboration.png)

#### Image description

Loopio working prototype showing live collaboration
...
![Loopio project redesign with bulk assignment controls](https://aaronwright.ca/portfolio/loopio-case-study/project-bulk-assignment.png)
...
![Loopio project list redesign](https://aaronwright.ca/portfolio/loopio-case-study/project-list-view.png)

#### Image description

Loopio project list redesign
...
![Recovered LoopUI Storybook documenting the Anchor component](https://aaronwright.ca/portfolio/loopio-case-study/loopui-storybook.png)
...
![Recovered LoopUI Storybook documentation for a selectable table](https://aaronwright.ca/portfolio/loopio-case-study/loopui-selectable-table.png)

#### Image description

Recovered LoopUI Storybook documentation for a selectable table
...
![A current Loopio proposal workspace with recognizable design-system lineage](https://aaronwright.ca/portfolio/loopio-case-study/current-proposal-summary.jpg)

#### Image description

A current Loopio proposal workspace with recognizable design-system lineage
...
![An early FreshBooks redesign exploration organized around clients](https://aaronwright.ca/portfolio/freshbooks-case-study/early-client-overview.png)
...
![An early FreshBooks redesign exploration combining client activity](https://aaronwright.ca/portfolio/freshbooks-case-study/early-client-activity.png)
...
![FreshBooks invoice editor with contextual settings in a right-side pane](https://aaronwright.ca/portfolio/freshbooks-current/invoice-create-filled.png)

#### Image description

FreshBooks invoice editor with contextual settings in a right-side pane
...
![FreshBooks switch-back flow asking which feature a customer needed](https://aaronwright.ca/portfolio/freshbooks-case-study/classic-missing-feature.png)

#### Image description

FreshBooks switch-back flow asking which feature a customer needed
...
![Current FreshBooks project creation flow using shared form and settings patterns](https://aaronwright.ca/portfolio/freshbooks-current/project-create-filled.png)
...
![The current FreshBooks invoices list](https://aaronwright.ca/portfolio/freshbooks-current/invoices-list-populated.png)

#### Image description

The current FreshBooks invoices list
...
![1 of 3: Homepage Overview](https://aaronwright.ca/portfolio/informal-systems/home-page.png)
...
![2 of 3: Hover-to-Edit](https://aaronwright.ca/portfolio/informal-systems/hover-to-edit.png)
...
![3 of 3: Informal Staking](https://aaronwright.ca/portfolio/informal-systems/informal-staking.png)
...
![2 of 6: Normalizer](https://aaronwright.ca/portfolio/aarons-toolbox/store-images--normalizer.png)
...
![3 of 6: Randomizer](https://aaronwright.ca/portfolio/aarons-toolbox/store-images--randomizer.png)
...
![4 of 6: Componentizer](https://aaronwright.ca/portfolio/aarons-toolbox/store-images--componentizer.png)
...
![5 of 6: Distributor](https://aaronwright.ca/portfolio/aarons-toolbox/store-images--distributor.png)
...
![6 of 6: Selection Saver](https://aaronwright.ca/portfolio/aarons-toolbox/store-images--selection-saver.png)
...
![2 of 10: NextPhrase home screen](https://aaronwright.ca/portfolio/nextphrase/nextphrase--1.png)

#### Image description

2 of 10: NextPhrase home screen

### Round start

![3 of 10: NextPhrase team scoreboard and round-start screen](https://aaronwright.ca/portfolio/nextphrase/nextphrase--2.png)

#### Image description

3 of 10: NextPhrase team scoreboard and round-start screen

### In game

![4 of 10: NextPhrase live round with a phrase and pass control](https://aaronwright.ca/portfolio/nextphrase/nextphrase--3.png)

#### Image description

4 of 10: NextPhrase live round with a phrase and pass control

### Hearts lost

![5 of 10: NextPhrase team screen with both teams missing hearts](https://aaronwright.ca/portfolio/nextphrase/nextphrase--4.png)

#### Image description

5 of 10: NextPhrase team screen with both teams missing hearts

### Winner

![6 of 10: NextPhrase winner screen for Team A](https://aaronwright.ca/portfolio/nextphrase/nextphrase--5.png)

#### Image description

6 of 10: NextPhrase winner screen for Team A

### Instructions

![7 of 10: NextPhrase how-to-play seating instructions](https://aaronwright.ca/portfolio/nextphrase/nextphrase--6.png)

#### Image description

7 of 10: NextPhrase how-to-play seating instructions

### Instructions passing

![8 of 10: NextPhrase how-to-play phrase-passing instructions](https://aaronwright.ca/portfolio/nextphrase/nextphrase--7.png)

#### Image description

8 of 10: NextPhrase how-to-play phrase-passing instructions

### Instructions winning

![9 of 10: NextPhrase how-to-play winning instructions](https://aaronwright.ca/portfolio/nextphrase/nextphrase--8.png)

#### Image description

9 of 10: NextPhrase how-to-play winning instructions

### Options

![10 of 10: NextPhrase options screen](https://aaronwright.ca/portfolio/nextphrase/nextphrase--9.png)

#### Image description

10 of 10: NextPhrase options screen
